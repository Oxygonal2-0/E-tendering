...
class ViewBiddedDetails extends StatefulWidget {
  final String id;
  const ViewBiddedDetails({
    Key? key,
    required this.id,
  }) : super(key: key);
  @override
  State<ViewBiddedDetails> createState() => _ViewBiddedDetailsState();
}

class _ViewBiddedDetailsState extends State<ViewBiddedDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text("Tender Response Details")),
